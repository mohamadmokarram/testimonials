...
const isMobileView = innerWidth < 500;

window.addEventListener("load", () => {
  if (isMobileView) {
    const targets = document.querySelectorAll(".timeline-view");
    Array.from(targets).forEach(elm => elm.classList.remove("timeline-view"));
  }
});
